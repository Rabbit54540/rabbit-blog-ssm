    ...
    <div class="row">
        <c:forEach items="${images}" var="images">
            <div class="col-xs-6 col-md-3">
                <a href="${images.userImage}" class="thumbnail" style="text-decoration: none">
                    <img src="${images.userImage}" style="width: 260px;height: 200px" alt="...">
                    <%--<p class="text-center" href="/image/deleteImage?id=${images.id}">删除</p>--%>
                </a>
            </div>
        </c:forEach>
    </div>
...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            <form enctype="multipart/form-data" action="/image/addimage" method="post">
                <button class="btn btn-primary" style="float:right;margin-left: 13px">确定</button>
                <label for="file" style="float:right;color: #2aabd2;font-size: 20px">上传图片</label>
