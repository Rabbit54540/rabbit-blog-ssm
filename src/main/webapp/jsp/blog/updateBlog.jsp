...
<div class="container panel panel-default">
    <form enctype="multipart/form-data" action="/blog/updateBlogById" method="post">
        <input type="hidden" name="blogType" value="${blogType}">
        <input type="hidden" name="blogId" value="${blogId}">
        <div class="panel-body">
            <div class="input-group input-group-lg">
                <input type="text" class="form-control" value="${blogTitle}" placeholder="输入标题" aria-describedby="sizing-addon1" style="padding-right: 356px;" name="blogTitle">
            </div>
            <textarea style="width: 100%;height: 100%;resize: none;width: 1120px;height: 300px;margin-top: 8px;margin-bottom: 3px;" class="mdl-textfield__input" type="text" name="blogBody"
                      id="blogBody" rows="3" maxrows="3">${blogBody}</textarea>
            <label class="mdl-textfield__label" for="blogBody"></label>
            <label for="file">上传封面</label>
            <input type="file" name=file id="file" style="display: none" />
            <button type="submit" style="text-align: center;background-color: #94bed2 " class="btn btn-default col-sm-offset-2 col-sm-10 navbar-right">确认修改</button>
        </div>
    </form>
