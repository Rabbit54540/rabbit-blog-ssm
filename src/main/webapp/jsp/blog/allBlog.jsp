        ...
        <div class="container">
            <nav aria-label="Page navigation" class="col-md-12 ">
                <ul class="pagination navbar-right  pagination-lg" style="margin-top: -22px;margin-bottom: 65px;">
                    <li>
                        <a href="/blog/allBlog?page=1&size=5" aria-label="Previous">
                            <span aria-hidden="true">首页</span>
                        </a>
                    </li>
                    <li>
                        <a href="/blog/allBlog?page=${blogs.pageNum-1}&size=5" aria-label="Previous">
                            <span aria-hidden="true">&laquo;</span>
                        </a>
                    </li>
                    <c:forEach begin="1" end="${blogs.pages}" var="pageNum" >
                        <li><a href="/blog/allBlog?page=${pageNum}&size=5">${pageNum}</a></li>
                    </c:forEach>
                    <%--<li><a href="#">1</a></li>--%>
                    <%--<li><a href="#">2</a></li>--%>
                    <%--<li><a href="#">3</a></li>--%>
                    ...
                    <%--<li><a href="#">5</a></li>--%>
                    <li>
                        <a href="/blog/allBlog?page=${blogs.pageNum+1}&size=5" aria-label="Next">
                            <span aria-hidden="true">&raquo;</span>
                        </a>
                    </li>
                    <li>
                        <a href="/blog/allBlog?page=${blogs.pages}&size=5" aria-label="Next">
