        ...
        <form action="/user/myBlog">
            <table class="mdl-data-table mdl-js-data-table mdl-data-table--selectable center"
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <button type="submit" style="text-align: center;background-color: #94bed2 " class="btn btn-default col-sm-offset-2 col-sm-12 navbar-right" >返回</button>
                    </td>
                </tr>
            </table>
        </form>
